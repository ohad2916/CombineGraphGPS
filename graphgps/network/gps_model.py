...
from graphgps.layer.gps_layer_ATTN import GPSLayerATTN
from graphgps.layer.gps_layer_MPNN import GPSLayerMPNN
...
class GPSModel(torch.nn.Module):
    ...
    def __init__(self, dim_in, dim_out):
        ...
        for _ in range(cfg.gt.layers - 2):
            layers.append(
                GPSLayerMPNN(
                    dim_h=cfg.gt.dim_hidden,
                    local_gnn_type=local_gnn_type,
        ...
        print(f"Starting with 1 ATTN >> {cfg.gt.layers - 2} MPNN >> 1 ATTN")
